...
class Data:
    ...
    def __init__(self, sources, destinations, timestamps, edge_idxs, labels, deceiver_labels):
...
def get_data(dataset_name, different_new_nodes_between_val_and_test=False):
    ...
    full_data = Data(sources, destinations, timestamps, edge_idxs, labels, deceiver_labels)
    ...
    train_data = Data(sources[train_mask], destinations[train_mask], timestamps[train_mask], edge_idxs[train_mask], labels[train_mask], deceiver_labels[train_mask])
    ...
    val_data = Data(sources[val_mask], destinations[val_mask], timestamps[val_mask], edge_idxs[val_mask], labels[val_mask], deceiver_labels[val_mask])
    test_data = Data(sources[test_mask], destinations[test_mask], timestamps[test_mask], edge_idxs[test_mask], labels[test_mask], deceiver_labels[test_mask])
    
    # validation and test with edges that at least has one new node (not in training set)
    new_node_val_data = Data(sources[new_node_val_mask], destinations[new_node_val_mask], 
                             timestamps[new_node_val_mask], edge_idxs[new_node_val_mask], 
                             labels[new_node_val_mask], deceiver_labels[new_node_val_mask])
    
    new_node_test_data = Data(sources[new_node_test_mask], destinations[new_node_test_mask],
                              timestamps[new_node_test_mask], edge_idxs[new_node_test_mask],
                              labels[new_node_test_mask], deceiver_labels[new_node_test_mask])
