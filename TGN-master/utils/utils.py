...
def eval_edge_prediction(model, negative_edge_sampler, data, n_neighbors, batch_size=200):
  ...
  ########################## Evaluate on val & test ##########################
def eval_deceiver_prediction(model, negative_edge_sampler, data, n_nodes, n_neighbors, batch_size=200):
  ...
  with torch.no_grad():
    ...
    for k in range(num_test_batch):
      ...
      deceiver_prob = model.compute_deceiver_probability(sources_batch, destinations_batch,
                                                            timestamps_batch, edge_idxs_batch, 1)
